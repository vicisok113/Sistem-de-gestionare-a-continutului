...
html .btn-primary {
	...
	background-color: <?=$primaryc?>;
	border-color: <?=$primaryc?> <?=$primaryc?> #1494cd;
}
...
html .btn-secondary {
	...
	text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25);
	background-color: <?=$secondary?>;
	border-color: <?=$secondary?> <?=$secondary?> #dec394;
}
...
html .btn-tertiary {
	...
	text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25);
	background-color: <?=$tertiary?>;
	border-color: <?=$tertiary?> <?=$tertiary?> #503c1a;
}
...
html .btn-quaternary {
	...
	text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25);
	background-color: <?=$quaternary?>;
	border-color: <?=$quaternary?> <?=$quaternary?> #b3b3b3;
}
...
html .btn-light-scale-2 {
	...
	text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25);
	background-color: #e6e6e6;
	border-color: #e6e6e6 #e6e6e6 <?=$quaternary?>;
}
