        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading"> Toate postarile &nbsp;&nbsp;<a href="<?php echo base_url().'admin/add_art'; ?>" class="btn btn-outline btn-primary">Adaugare</a></div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="<?php echo base_url().'admin/edit_art/'.$id; ?>"><?php echo $nume; ?></a></td>
                                            <td><a href="<?php echo base_url().'blog/'.$id.'/'.$linie; ?>"><i style="font-size:25px; color:#000;" class="fa fa-eye"></i></a></td>
                                            <td><?php echo $categorie; ?></td>
                                            <td><a href="<?php echo base_url().'admin/edit_art/'.$id; ?>"><i style="font-size:25px; color:#000;" class="fa fa-pencil fta"></i></a></td>
                                            <td><a href="<?php echo base_url().'admin/delete_art/'.$id; ?>"><i style="font-size:25px; color:#000;" class="fa fa-trash-o fta"></i></a></td>
                                        </tr>
                                    </tbody>
                                    <?php } ?>
                                </table>
