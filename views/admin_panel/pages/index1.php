...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="<?php echo base_url().'application/views/admin_panel/bower_comonents/metisMenu/dist/metisMenu.min.css'; ?>" rel="stylesheet">

    <!-- Timeline CSS -->
    <link href="<?php echo base_url().'application/views/admin_panel/dist/css/timeline.css'; ?>" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="<?php echo base_url().'application/views/admin_panel/dist/css/sb-admin-2.css'; ?>" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="<?php echo base_url().'application/views/admin_panel/bower_components/morrisjs/morris.css'; ?>" rel="stylesheet">
...
<body>
    ...
    <script src="<?php echo base_url().'application/views/admin_panel/bower_components/raphael/raphael-min.js'; ?>"></script>
    <script src="<?php echo base_url().'application/views/admin_panel/bower_components/morrisjs/morris.min.js'; ?>"></script>
    <script src="<?php echo base_url().'application/views/admin_panel/js/morris-data.js'; ?>"></script>
