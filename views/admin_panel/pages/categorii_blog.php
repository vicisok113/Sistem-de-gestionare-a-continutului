            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="panel-body">
                     ...
                     echo form_open('index.php/admin/add_cat_blog_validation', $attributes); ?>
                            <fieldset>
                            <p><?php echo validation_errors(); ?></p>
                                ...
                                <label>Categorie parinte: </label>
                                    ...
                                    <?php $query = $this->db->query("SELECT * FROM categorii_blog WHERE parinte = '0'");
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <?php 
                                    $query = $this->db->query("SELECT * FROM categorii_blog");
                                    foreach ($query->result() as $row)
                                    {
                                        $id = $row->id;
                                        $categorie = $row->categorie;
                                    ...
                                    <?php if($parinte == '0'){?>
                                        <tr>
                                            <td><a href="<?php echo base_url().'index.php/admin/edit_cat_blog/'.$id; ?>"><?php echo $categorie; ?></a></td>
                                            <td>Niciuna</td>
                                            <td><a href="<?php echo base_url().'index.php/admin/edit_cat_blog/'.$id; ?>"><i style="font-size:25px; color:#000;" class="fa fa-pencil fta"></i></a></td>
                                            <td><a href="<?php echo base_url().'index.php/admin/delete_cat_blog/'.$id; ?>"><i style="font-size:25px; color:#000;" class="fa fa-trash-o fta"></i></a></td>
                                        </tr>
                                        <?php $query = $this->db->query("SELECT * FROM categorii_blog WHERE parinte = '".$id."'");
                                        foreach ($query->result() as $row)
                                        {
                                        	$id1 = $row->id;
                                         ...
                                         ?>
                                         <tr>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url().'index.php/admin/edit_cat_blog/'.$id1; ?>"><?php echo $subcategorie; ?></a></td>
                                            <td><?php $query2 = $this->db->query("SELECT * FROM categorii_blog WHERE id ='".$parinte1."' ");
                                                        foreach ($query2->result() as $row)
                                                        {
                                                            $categorie1 = $row->categorie;
                                                            echo $categorie1;
                                                        } ?></td>
                                            <td><a href="<?php echo base_url().'index.php/admin/edit_cat_blog/'.$id1; ?>"><i style="font-size:25px; color:#000;" class="fa fa-pencil fta"></i></a></td>
                                            <td><a href="<?php echo base_url().'index.php/admin/delete_cat_blog/'.$id1; ?>"><i style="font-size:25px; color:#000;" class="fa fa-trash-o fta"></i></a></td>
                                        </tr>
                                        <? }} ?>
                                    </tbody>
                                    <?php } ?>
