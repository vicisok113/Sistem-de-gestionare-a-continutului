        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading"> Toate produsele &nbsp;&nbsp;<a href="<?php echo base_url().'admin/add_produs'; ?>" class="btn btn-outline btn-primary">Adaugare</a></div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <?php 
                                    $query = $this->db->query("SELECT * FROM produse");
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="<?php echo base_url().'admin/edit_produs/'.$id; ?>"><?php echo $nume; ?></a></td>
                                            <td><a href="<?php echo base_url().'produse/'.$id.'/'.$linie; ?>"><i style="font-size:25px; color:#000;" class="fa fa-eye"></i></a></td>
                                            <td><?php echo $pret; ?></td>
                                            <td><?php echo $categorie; ?></td>
                                            <td><a href="<?php echo base_url().'admin/edit_produs/'.$id; ?>"><i style="font-size:25px; color:#000;" class="fa fa-pencil fta"></i></a></td>
                                            <td><a href="<?php echo base_url().'admin/delete_produs/'.$id; ?>"><i style="font-size:25px; color:#000;" class="fa fa-trash-o fta"></i></a></td>
                                        </tr>
                                    </tbody>
                                    <?php } ?>
                                </table>
