...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <?php
                $query = $this->db->query("SELECT * FROM categorii_blog WHERE id = '". $name ."'");
                ...
                ?>
                    ...
                    <div class="panel-body">
                     ...
                     echo form_open('index.php/admin/edit_cat_blog_validation/'.$id, $attributes);?>
                            <fieldset>
                            <p><?php echo validation_errors(); ?></p>
                                ...
                                <label>Categorie parinte: </label>
                                    ...
                                    <?php $query1 = $this->db->query("SELECT * FROM categorii_blog WHERE parinte = '0'");
