            ...
            <!-- /.container-fluid -->
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Adaugare pagina</h3>
                    </div>
                    <div class="panel-body">
                     <?php $attributes = array('class' => '', 'role' => 'form');
                     echo form_open_multipart('index.php/admin/add_page_validation', $attributes); ?>
                            <fieldset>
                            <p><?php echo validation_errors(); ?></p>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" value="1" name="show_menu">Apare in meniu
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" value="1" name="target">Target blank
                                    </label>
                                </div>
                                <div class="form-group">
