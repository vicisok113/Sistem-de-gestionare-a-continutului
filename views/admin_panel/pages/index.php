                    ...
                    <div class="panel panel-primary">
                        ...
                        <a target="_blank" href="<?php echo base_url().'index.php'; ?>">
                            <div class="panel-footer">
                                <span class="pull-left">Vezi site</span>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                 	<?php $i=0;
                                 	$query = $this->db->query("SELECT * FROM comenzi");
                        ...
                        <a target="_blank" href="<?php echo base_url().'admin/comenzi'; ?>">
                            <div class="panel-footer">
                                <span class="pull-left">Vezi pagina</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
