            ...
            ?>
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                     ...
                     echo form_open_multipart('index.php/admin/edit_produs_validation/'.$id, $attributes); ?>
                            <fieldset>
                            <p><?php echo validation_errors(); ?></p>
                                ...
                                <div class="form-group">
                                    <label>Pret</label>
                                    <input value="<?php echo $pret; ?>" class="form-control" placeholder="Pret" name="pret" type="text" autofocus>
                                </div>
                                <div class="form-group">
