            ...
            <!-- /.container-fluid -->
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Adaugare produs</h3>
                    </div>
                    <div class="panel-body">
                     <?php $attributes = array('class' => '', 'role' => 'form');
                     echo form_open_multipart('index.php/admin/add_produs_validation', $attributes); ?>
                            <fieldset>
                            <p><?php echo validation_errors(); ?></p>
                                ...
                                <div class="form-group">
                                    ...
                                    foreach ($query->result() as $row)
                                    {
                                        ...
                                        <?php } 
                                        $query = $this->db->query("SELECT * FROM categorii_produse WHERE parinte = '".$id1."'");
                                        foreach ($query->result() as $row)
                                        {
                                ...
                                <div class="form-group">
                                    <label>Pret</label>
                                    <input class="form-control" placeholder="Pret" name="pret" type="text" autofocus>
                                </div>
                                <div class="form-group">
                                    <label>Seo titie</label>
