...
<html class="<?php if($layout == 1) { echo ' boxed'; } if($bgcolor == 1) { echo ' dark'; } ?>">
	...
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url().'application/views/template7/';?>vendor/rs-plugin/css/settings.css" media="screen">
		...
		<script src="<?php echo base_url().'application/views/template7/';?>vendor/modernizr/modernizr.min.js"></script>
	...
	<body>
		...
		<div class="body">
			...
			<div role="main" class="main">
			  ...
			  if($show == 1) { ?>
				...
				<section class="parallax section section-text-light section-parallax section-center mt-xl mb-none" data-stellar-background-ratio="0.5" style="background-image: url(<?php echo base_url().'application/views/template7/';?>img/parallax-people.jpg);">
		...
		<script src="<?php echo base_url().'application/views/template7/';?>vendor/jquery.appear/jquery.appear.min.js"></script>
		...
		<script src="<?php echo base_url().'application/views/template7/';?>vendor/rs-plugin/js/jquery.themepunch.tools.min.js"></script>

		<script src="<?php echo base_url().'application/views/template7/';?>vendor/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
