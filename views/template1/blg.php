...
<p class="pret"><?php echo $descriere; ?></p>
...
<p>...<a href="<?php echo base_url();?>#blog">Blog</a>/<a href="<?php echo base_url();?>#<?php echo $categorie?>"><?php echo $categorie?></a>/<a href="<?php echo base_url().'index.php/main/blg/'.$name; ?>" class="view-detail"><?php echo $nume;?></a></p>
