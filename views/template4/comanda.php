...
<html class="<?php if($layout == 1) { echo ' boxed'; } if($bgcolor == 1) { echo ' dark'; } ?>">
	...
	<head>
		...
		<link rel="shortcut icon" href="<?php echo base_url().'application/views/template4/'; ?>img/favicon.ico" type="image/x-icon" />

		<link rel="apple-touch-icon" href="<?php echo base_url().'application/views/template4/'; ?>img/apple-touch-icon.png">
		...
		<link rel="stylesheet" href="<?php echo base_url().'application/views/template4/'; ?>vendor/simple-line-icons/css/simple-line-icons.min.css">

		<link rel="stylesheet" href="<?php echo base_url().'application/views/template4/'; ?>vendor/owl.carousel/assets/owl.carousel.min.css">

		<link rel="stylesheet" href="<?php echo base_url().'application/views/template4/'; ?>vendor/owl.carousel/assets/owl.theme.default.min.css">

		<link rel="stylesheet" href="<?php echo base_url().'application/views/template4/'; ?>vendor/magnific-popup/magnific-popup.min.css">
		...
		<link rel="stylesheet" href="<?php echo base_url().'application/views/template4/'; ?>css/theme-blog.css">

		<link rel="stylesheet" href="<?php echo base_url().'application/views/template4/'; ?>css/theme-shop.css">

		<link rel="stylesheet" href="<?php echo base_url().'application/views/template4/'; ?>css/theme-animate.css">
		...
		<link rel="stylesheet" href="<?php echo base_url().'application/views/template4/'; ?>css/custom.css">

		<!-- Head Libs -->

		<script src="<?php echo base_url().'application/views/template4/'; ?>vendor/modernizr/modernizr.min.js"></script>
	...
	<body>
		...
		<script src="<?php echo base_url().'application/views/template4/'; ?>vendor/jquery.appear/jquery.appear.min.js"></script>

		<script src="<?php echo base_url().'application/views/template4/'; ?>vendor/jquery.easing/jquery.easing.min.js"></script>

		<script src="<?php echo base_url().'application/views/template4/'; ?>vendor/jquery-cookie/jquery-cookie.min.js"></script>

		<script src="<?php echo base_url().'application/views/template4/'; ?>vendor/bootstrap/js/bootstrap.min.js"></script>

		<script src="<?php echo base_url().'application/views/template4/'; ?>vendor/common/common.min.js"></script>

		<script src="<?php echo base_url().'application/views/template4/'; ?>vendor/jquery.validation/jquery.validation.min.js"></script>

		<script src="<?php echo base_url().'application/views/template4/'; ?>vendor/jquery.stellar/jquery.stellar.min.js"></script>

		<script src="<?php echo base_url().'application/views/template4/'; ?>vendor/jquery.easy-pie-chart/jquery.easy-pie-chart.min.js"></script>

		<script src="<?php echo base_url().'application/views/template4/'; ?>vendor/jquery.gmap/jquery.gmap.min.js"></script>

		<script src="<?php echo base_url().'application/views/template4/'; ?>vendor/jquery.lazyload/jquery.lazyload.min.js"></script>

		<script src="<?php echo base_url().'application/views/template4/'; ?>vendor/isotope/jquery.isotope.min.js"></script>

		<script src="<?php echo base_url().'application/views/template4/'; ?>vendor/owl.carousel/owl.carousel.min.js"></script>

		<script src="<?php echo base_url().'application/views/template4/'; ?>vendor/magnific-popup/jquery.magnific-popup.min.js"></script>
